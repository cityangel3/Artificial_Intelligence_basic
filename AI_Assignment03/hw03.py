...
def logic02_02():
    ...
    ################# Write Your Code Here #########################
    #return Exists('$x', Exists('$y',Equiv(Person('$x'), Not(Child('$x','$y')))))
    return Not(Forall('$x',Exists('$y',Equiv(Person('$x'), Child('$x','$y')))))
    ################################################################
...
def suspect():
    ...
    formulas.append(Exists('$x',Forall('$y',And(TellTruth('$x'),Equiv(Not(Equals('$x', '$y')),Not(TellTruth('$y')))))))
    formulas.append(Exists('$x',Forall('$y',And(CrashedServer('$x'),Equiv(Not(Equals('$x', '$y')),Not(CrashedServer('$y')))))))
    ################################################################
    # Query: Who did it?
...
def number_theorem():
    ...
    query = None
    ################# Write Your Code Here #########################
    formulas.append(Forall('$x',Exists('$z',And(Forall('$y',Equiv(Successor('$x','$y'),Equals('$y','$z'))),Not(Equals('$x','$z'))))))
